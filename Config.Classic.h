...
#define LIMIT_SENSE_ON    // LF: era OFF
...
#define STATUS_LED_PINS_ON     // LF: era OFF
...
#define REMEMBER_AUTO_MERIDIAN_FLIP_ON   // LF: era OFF
...
#define REMEMBER_MAX_RATE_ON         // set to _ON and OnStep will remember rates set in the ASCOM driver, Android App, etc. default=_OFF
                                     // LF: era OFF
#define MaxRate                   16 // this is the number of micro-seconds between micro-steps default setting and can be adjusted for two times lower or higher at run-time
...
#define DegreesForRapidStop      3.0 // approximate number of degrees required to stop when requested or if limit is exceeded during a slew: higher values=longer deceleration
...
#define BacklashTakeupRate        25 // backlash takeup rate (in multipules of the sidereal rate): too fast and your motors will stall,
                                     ...
                                     // Axis1 is for RA/Az
#define StepsPerDegreeAxis1  56000.0 // calculated as    :  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
                                     // G11              :  400           * 32          * 1               *  360/360              = 12800
                                     // Axis2 is for Dec/Alt
                                     // LF: era 12800.0
#define StepsPerDegreeAxis2  56000.0 // calculated as    :  stepper_steps * micro_steps * gear_reduction1 * (gear_reduction2/360)
                                     // G11              :  400           * 32          * 1               *  360/360              = 12800
                                     ...
                                     // LF: era 12800.0
#define StepsPerWormRotationAxis1 36000L  // LF: era 12800L
...
#define MinutesPastMeridianE     360 // for goto's, how far past the meridian to allow before we do a flip (if on the East side of the pier) - one hour of RA is the default = 60.  Sometimes used for Fork mounts in Align mode.  Ignored on Alt/Azm mounts.
                                     // LF: era 30
#define MinutesPastMeridianW     360 // as above, if on the West side of the pier.  If left alone, the mount will stop tracking when it hits the this limit.  Sometimes used for Fork mounts in Align mode.  Ignored on Alt/Azm mounts.
                                     // LF: era 30
...
#define UnderPoleLimit            10 // maximum allowed hour angle (+/-) under the celestial pole.  Default=12.  Ignored on Alt/Azm mounts.
                                     // If left alone, the mount will stop tracking when it hits this limit.  Valid range is 10 to 12 hours.
                                     // LF: era 12 il valore di damiano sarebbe 9, ma qui dice di non andare sotto 10
...
#define FOCUSER2_ON                  // enable or disable focuser feature, default=_OFF
                                     // LF: era OFF
